...
//This creates your own GraphQL connection.
//But if you want to change it --> modify the uri to point to your online graphQL thing. [] const client = new ApolloClient ({ uri })
